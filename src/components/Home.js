    ...
    <main>
      ...
      <section className="relative flex justify-center min-h-scren pt-12 lg:pt-64 px-8">
        <h1 className="text)6xl text-green-100 font-bold text-outline cursive leading-none lg:leading-snug home-name">
          {" "}
          <div className="text text-1">P</div>
          <div className="text text-2">O</div>
          <div className="text text-3">R</div>
          <div className="text text-4">T</div>
          <div className="text text-3">F</div>
          <div className="text text-2">O</div>
          <div className="text text-1">L</div>
